...
declare const STATUSES: {
    ...
    loading: {
        icon: import("@chakra-ui/react").ComponentWithAs<"div", import("@chakra-ui/react/spinner").SpinnerProps>;
        colorScheme: string;
    };
};
export declare function getStatusColorScheme(status: AlertStatus): string;
export declare function getStatusIcon(status: AlertStatus): import("@chakra-ui/react").ComponentWithAs<"div", import("@chakra-ui/react/spinner").SpinnerProps> | typeof InfoIcon | typeof WarningIcon | typeof CheckIcon;
