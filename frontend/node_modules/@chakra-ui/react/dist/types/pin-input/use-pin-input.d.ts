...
export declare const PinInputDescendantsProvider: import("react").Provider<import("@chakra-ui/react/descendant").DescendantsManager<HTMLInputElement, {}>>, usePinInputDescendantsContext: () => import("@chakra-ui/react/descendant").DescendantsManager<HTMLInputElement, {}>, usePinInputDescendants: () => import("@chakra-ui/react/descendant").DescendantsManager<HTMLInputElement, {}>, usePinInputDescendant: (options?: {
...
export declare function usePinInput(props?: UsePinInputProps): {
    ...
    id: string;
    descendants: import("@chakra-ui/react/descendant").DescendantsManager<HTMLInputElement, {}>;
    values: string[];
